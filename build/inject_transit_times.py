...
# transit_times.json is generated by this script — not required as input
# (kept for reference only)
_json_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "transit_times.json")
